...
/**
 * Writes a service characteristic to the Light PlayBulb Candle
 *
 * @param {Number} value value to write
 * @param {Function} callback function to call when done
 * @return {void}
 */
Driver.prototype._writeServiceCharacteristic = function(value, callback) {
  this.connection.writeServiceCharacteristic(new Buffer(value),
    function(err, data) {
